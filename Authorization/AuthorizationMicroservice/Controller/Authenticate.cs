...
namespace Authorization.Controllers
{
    ...
    public class Authenticate : ControllerBase
    {
        ...
        public IActionResult GetResult()
        {
            ...
            result.valid = true;
          //  Request.Headers.TryGetValue("", out var tok);
            return Ok(result);
        }
        ...
        new UserModel{EmployeeId=2121509,Password="12345"},
        new UserModel{EmployeeId=2121183,Password="12345"},
        new UserModel{EmployeeId=2122962,Password="12345"},
