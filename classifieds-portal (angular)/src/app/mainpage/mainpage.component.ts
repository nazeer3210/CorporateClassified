...
export class MainpageComponent implements OnInit {
  ...
  @ViewChild("OpenedDate") OpenedDate: ElementRef = new ElementRef("");
  ...
  //filter the posts by the Opened date
  filterByOpenedDate() {
    let OpenedDate = this.OpenedDate.nativeElement.value
    if (this.token != null)
      this.configService.getOffersByOpenedDate(this.token, OpenedDate).subscribe((data: Offer[]) => {
        console.log(data);
        this.offers = data;
      },
        error => {
